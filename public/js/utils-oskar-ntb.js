...
function clock() {
    ...
    document.querySelector(".time-tooltip > :nth-child(1)").textContent = new Intl.DateTimeFormat("cs-CZ", {
        dateStyle: "long"
    }).format(date)
    document.querySelector(".time-tooltip > :nth-child(2)").textContent = new Intl.DateTimeFormat("cs-CZ", {
        weekday: "short",
        hour: "numeric",
        minute: "numeric",
        second: "numeric",
